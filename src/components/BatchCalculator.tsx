                ...
                <CardContent className="pt-6">
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-2">
                        {calculation.ingredients.map((ingredient, index) => (
                          <li key={index} className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {ingredient.batchAmount.toFixed(2)}{" "}
                              {ingredient.unit}
                            </span>
                          </li>
                        ))}
                        <li className="flex justify-between border-t pt-2 mt-2">
                          ...
                          <span className="font-medium">
                            {calculation.waterAmount.toFixed(2)} oz
                          </span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-muted p-3 rounded-md">
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold">
                          {calculation.totalVolume.toFixed(2)} oz
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      <p>
                        This calculation adds water to account for the dilution
                        that normally occurs during mixing/stirring.
                      </p>
                    </div>
                  </div>
                </CardContent>
